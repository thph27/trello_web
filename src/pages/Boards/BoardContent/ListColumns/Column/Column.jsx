...
function Column({ column, createNewCard, deleteColumnDetails }) {
  ...
  const dndKitColumnStyles = {
    touchAction: 'none',
    // Neu su dung CSS.Transform thi se bi stretch
  ...
  const handleDeleteColumn = () => {
    confirmDeleteColumn({
      ...
      // description: 'Type: "I am sure" to confirm',
      // confirmationKeyword: 'I am sure'
    }).then(() => {
      // Goi len props function deleteColumnDetails nam o component cha: _id.jsx
